      ...
      <div className="w-full max-w-7xl bg-[#004aad] p-4 md:p-6 rounded-xl shadow-sm border border-gray-200 mb-6 no-print">
        ...
        <div className="bg-[#004aad] text-white pt-2 pb-3 px-4 text-center">
          <div className="flex justify-center items-center">
            <span className="md:text-[40px] text-[28px] font-black tracking-tighter text-[#ffcb05]">One</span>
            <span className="md:text-[40px] text-[28px] font-black tracking-tighter text-white">Beyond Store Hub</span>
